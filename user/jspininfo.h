...
#define JSH_PORTB_OFFSET 0
#define JSH_PORTC_OFFSET 0
#define JSH_PORTD_OFFSET 0
#define JSH_PORTE_OFFSET 0
#define JSH_PORTF_OFFSET 0
#define JSH_PORTG_OFFSET 0
#define JSH_PORTH_OFFSET 0
